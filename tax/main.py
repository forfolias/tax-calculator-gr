...
def main():
    ...
    for employment_type_name in employment_type_names:
        ...
        console.print(f"Employment type: [bold]{employment_class.title}[/bold]")
        console.print(f"Annual net income: {calculator.get_annual_net_salary():.2f}€")
        console.print(f"Monthly net income: {calculator.get_monthly_net_salary():.2f}€")
